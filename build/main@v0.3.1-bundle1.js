...
var pages = {
  "home": function home() {
    return window.__etcpack__getLazyBundle('./build/main@v0.3.1-bundle3.js','31');
  },
  "basic": function basic() {
    return window.__etcpack__getLazyBundle('./build/main@v0.3.1-bundle4.js','32');
  },
  "problem": function problem() {
    return window.__etcpack__getLazyBundle('./build/main@v0.3.1-bundle5.js','33');
  },
  "example": function example() {
    return window.__etcpack__getLazyBundle('./build/main@v0.3.1-bundle6.js','34');
  }
};
